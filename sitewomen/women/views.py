...
data_db = [
    {'id': 1, 'title': 'Анджелина Джоли', 'content': '''<h1>Анджелина Джоли</h1> (англ. Angelina Jolie, при рождении Войт, ранее Джоли Питт; род. 4 июня 1975, Лос-Анджелес, Калифорния, США) — 
